from wabApp.blueprints import main_bp, admin_bp, debug_bp
from logging.handlers import RotatingFileHandler
from wabApp.api import Products, Product
from wabApp.api import Members, Member
from flask_migrate import Migrate
from wabApp.api import Admins, Admin
from wabApp.api import Orders, Order
...
def create_app():
    ...
    print(config['development'].DB_URI)
    ...
    log_file = 'wabApp/logs/wabApp.log'
    ...
    migrate = Migrate(flask_app, db, directory='wabApp/migrations')
